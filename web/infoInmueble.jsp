...
%>
	...
	<div class="container">
		<div class="page-header">
			<h1>
				<%= inmueble.getLocalizacion().getPoblacion()%> <small><%= inmueble.getLocalizacion().getNombreDir()%></small>
			</h1>
		</div>
		<div class="row">
			<div class="col-md-4">
				<div class="informacion">
					<ul class="centrar-v">
						...
						<li><span class="titulos">Número de baños:</span><p><%=inmueble.getNumBagnos()%></p></li>
						<%
							String listaExtras  ="";
						...
						%>
						<li><span class="titulos">Extras:</span><p> <%= listaExtras%> </p></li>
					</ul>
				</div>
			</div>
			<div class="col-md-8">
