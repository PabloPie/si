                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <div class="pull-right">
                            <button type="submit" name="envio" value="actualiza" class="btn btn-primary form-control">Save</button>
                        </div>
                        <div class="pull-left">
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#ModalDelete">Borrar cuenta</button>
                        </div>
                    </div>
                </div>
