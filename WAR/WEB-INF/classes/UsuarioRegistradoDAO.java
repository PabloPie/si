...
public class UsuarioRegistradoDAO {
    ...
    public static void insertarUsuario(UsuarioRegistradoVO usuario, Connection connection) {
	try {
	    /* Create "preparedStatement". */
	    String queryString = "INSERT INTO usuario_registrado "
		    + "(idusuario, nombre, apellidos, email, telefono, contraseña, fecha, idpais,"
		    + "idprovincia, poblacion, nombredir, numerodir, idvia) " + "VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public static void actualizarUsuario(UsuarioRegistradoVO usuario, Connection connection) {
	try {
	    /* Create "preparedStatement". */
	    String queryString = "UPDATE usuario " + "SET nombre = ?, apellidos = ?, email = ?, telefono = ?, "
    ...
    public static UsuarioRegistradoVO encontrarDatosUsuario(String idusuarioUsuario, Connection connection) {
	...
	try {
	    ...
	    LocalizacionVO location = LocalizacionDAO.obtenerLocalizacion(idpais, idprovincia, poblacion, nombredir,
		    numerodir, idvia, connection);

	    usuarioVO = new UsuarioRegistradoVO(idusuarioUsuario, nombre, apellidos, claveEncriptada, telefono, email,
		    date, location);
