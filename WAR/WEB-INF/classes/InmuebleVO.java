...
public class InmuebleVO {
    ...
    public InmuebleVO(int idInmueble, double precio, int superficie, int planta, int numHabitaciones, int numBagnos,
	    String descripcion, boolean seVende, boolean seAlquila, TipoInmuebleVO idTipoInmueble,
