...
public class TipoInmuebleDAO {
    ...
    public static TipoInmuebleVO getTipoInmuebleById(int idTipo, Connection connection) {
        ...
        try {
            ...
            String nombreTipo = resultSet.getString(Tablas.TipoInmueble.NOMBRE_TIPO);
    ...
    public static List<TipoInmuebleVO> getAllTipoInmueble(Connection connection) {
